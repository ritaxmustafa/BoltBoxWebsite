    ...
    return(
        <div className="container guide">
            <SubTitle text="Pet Portraits Photo Guide"  class="pt-20"/>
              <p className="pt-20">The quality of your artwork greatly relies on the quality of your reference photo. Ensure that your pet is directly facing the camera at eye level, under favorable lighting conditions, with a clear view of the face and neck.</p>
              ...
              <p className="ptb-20">Send it to info@bolt-box.com and I'll take a look.</p>
        </div>
    )
}
