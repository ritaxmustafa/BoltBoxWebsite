  ...
  return (
    <div className="container ">
      ...
      <div className="privacy">
        ...
        <p>information or advertising relating to our products or services.</p>
        <p className="pt-20">
        ...
        <p className="pb-20">
          ...
          by e-mail at info@bolt-box.com or by mail using the details provided
          below:
        </p>
      </div>
    </div>
